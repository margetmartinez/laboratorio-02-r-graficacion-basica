...
author: "Marget Aracelly Martínez"
date: "2020-04-28"
output:
  html_document:
    theme: readable    
...
```{r}
#vector de nombre de países
paises = c("BLZ", "NIC", "GTM", "HND", "SLV", "CRI", "PAN", "DOM" )

# vector de casos confirmados
confirmados = c(18, 10, 316, 510, 237, 681, 4821, 5300)

# data frame de ambos vectores
ca_covid19 = data.frame(
                        pais = paises, 
...
barplot(
  ...
  main="Casos confirmados de Covid-19 en Centroamérica y República Dominicana"
)
```
...
# vector de casos activos
activos = c(14, 1, 282, 434, 167, 495, 4451, 4459)
...
barplot(
  ...
  xlab="País", 
  ylab="Casos activos", 
  main="Casos activos de Covid-19 en Centroamérica y República Dominicana"
)
...
# vector de fallecidos
fallecidos = c(2, 2, 10, 46, 7, 6, 141, 260)
...
barplot(
  ...
  xlab="País", 
  ylab="Fallecidos", 
  main="Fallecidos por Covid-19 en Centroamérica y República Dominicana"
)
```
